        ...
        <div className="container-xxl flex-grow-1 container-p-y">
          ...
          <div className="row mb-5">
            <div className="col-md-6 col-lg-4 mb-3">
              <div className="card h-100">
                <img className="card-img-top" src="img/elements/2.jpg" alt="Card image cap" />
                <div className="card-body">
                  <h5 className="card-title">Card title</h5>
                  <p className="card-text">
                    Some quick example text to build on the card title and make up the bulk of the card's content.
                  </p>
                  <a href="test.html" className="btn btn-outline-primary">Go somewhere</a>
                </div>
              </div>
            </div>
            <div className="col-md-6 col-lg-4 mb-3">
              <div className="card h-100">
                ...
                <img className="img-fluid" src="img/elements/13.jpg" alt="Card image cap" />
                <div className="card-body">
                  <p className="card-text">Bear claw sesame snaps gummies chocolate.</p>
                  <a href="test.html;" className="card-link">Card link</a>
            ...
            <div className="col-md-6 col-lg-4 mb-3">
              <div className="card h-100">
                <div className="card-body">
                  <h5 className="card-title">Card title</h5>
                  <h6 className="card-subtitle text-muted">Support card subtitle</h6>
                  <img className="img-fluid d-flex mx-auto my-4" src="img/elements/4.jpg" alt="Card image cap" />
                  <p className="card-text">Bear claw sesame snaps gummies chocolate.</p>
                  <a href="test.html;" className="card-link">Card link</a>
                  <a href="test.html;" className="card-link">Another link</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row mb-5">
            ...
            <div className="col-md-6 col-lg-4">
              ...
              <div className="card mb-4">
                <img className="card-img-top" src="img/elements/5.jpg" alt="Card image cap" />
                <div className="card-body">
                  <p className="card-text">
                    Some quick example text to build on the card title and make up the bulk of the card's content.
                  </p>
            ...
            <div className="col-md-6 col-lg-4">
              ...
              <div className="card">
                <img className="card-img-top" src="img/elements/7.jpg" alt="Card image cap" />
                <div className="card-body">
                  <h5 className="card-title">Card title</h5>
            ...
            <div className="col-md-6 col-lg-4 mb-3">
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <a href="test.html" className="btn btn-primary">Go somewhere</a>
                </div>
              </div>
            </div>
            <div className="col-md-6 col-lg-4 mb-3">
          ...
          <div className="row mb-5">
            <div className="col-md-6 col-xl-4">
              <div className="card mb-3">
                <img className="card-img-top" src="img/elements/18.jpg" alt="Card image cap" />
                <div className="card-body">
                  <h5 className="card-title">Card title</h5>
                  <p className="card-text">
            ...
            <div className="col-md-6 col-xl-4">
              <div className="card mb-3">
                ...
                <img className="card-img-bottom" src="img/elements/1.jpg" alt="Card image cap" />
              </div>
            </div>
            <div className="col-md-6 col-xl-4">
              <div className="card bg-dark border-0 text-white">
                <img className="card-img" src="img/elements/11.jpg" alt="Card image" />
              ...
              <div className="card mb-3">
                <div className="row g-0">
                  <div className="col-md-4">
                    <img className="card-img card-img-left" src="img/elements/12.jpg" alt="Card image" />
                  </div>
            ...
            <div className="col-md">
              <div className="card mb-3">
                <div className="row g-0">
                  ...
                  <div className="col-md-4">
                    <img className="card-img card-img-right" src="img/elements/17.jpg" alt="Card image" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="card-group mb-5">
            <div className="card">
              <img className="card-img-top" src="img/elements/4.jpg" alt="Card image cap" />
              <div className="card-body">
                <h5 className="card-title">Card title</h5>
                <p className="card-text">
                  This is a wider card with supporting text below as a natural lead-in to additional content. This
            ...
            <div className="card">
              <img className="card-img-top" src="img/elements/1.jpg" alt="Card image cap" />
              <div className="card-body">
                <h5 className="card-title">Card title</h5>
                <p className="card-text">
                  This is a wider card with supporting text below as a natural lead-in to additional content. This
          ...
          <div className="row row-cols-1 row-cols-md-3 g-4 mb-5">
            ...
            <div className="col">
              <div className="card h-100">
                <img className="card-img-top" src="img/elements/13.jpg" alt="Card image cap" />
                <div className="card-body">
                  <h5 className="card-title">Card title</h5>
                  <p className="card-text">
                    This is a longer card with supporting text below as a natural lead-in to additional content.
            ...
            <div className="col">
              <div className="card h-100">
                <img className="card-img-top" src="img/elements/19.jpg" alt="Card image cap" />
                <div className="card-body">
                  <h5 className="card-title">Card title</h5>
                  <p className="card-text">
                    This is a longer card with supporting text below as a natural lead-in to additional content.
            ...
            <div className="col">
              <div className="card h-100">
                <img className="card-img-top" src="img/elements/20.jpg" alt="Card image cap" />
                <div className="card-body">
                  <h5 className="card-title">Card title</h5>
                  <p className="card-text">
                    This is a longer card with supporting text below as a natural lead-in to additional content.
