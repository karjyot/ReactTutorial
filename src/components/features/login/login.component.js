...
import { useComponentDidMount,useComponentDidUpdate,useComponentWillUnmount
} from "./../../../libs/util";
import {Link} from "react-router-dom";
import { authentication } from "./../../../actions/auth-actions";
  ...
  loginUser(e){
    ...
    this.props
      ...
      .then((response) => {
        ...
        this.setState({ loginSuccesfull : response });
       //console.log(this.state)
      })
      .catch((e) => {
        console.log(e)
        this.setState({isError:true})
        this.setState({errorMsg:e.data.error.msg})
        //console.log(e);
      });
  }
                       ...
                       <div className="authentication-inner">
                         ...
                         <div className="card">
                           <div className="card-body">
                            ...
                            {this.state.loginSuccesfull && (
                            
                            <Navigate to="/dashboard" replace={true} />
                          )}
                             <form id="formAuthentication" className="mb-3"   onSubmit={this.loginUser}>
                               <div className="mb-3">
                                 <label htmlFor="email" className="form-label">Email or Username</label>
                                 <input type="text" className="form-control" id="email" onChange={this.handleChange} name="username" placeholder="Enter your email or username"  />
                               </div>
                               <div className="mb-3 form-password-toggle">
                                 ...
                                 <div className="input-group input-group-merge">
                                   <input type="password" id="password" className="form-control" name="password" placeholder="············" aria-describedby="password" onChange={this.handleChange} />
...
//              <h4 className="mb-2">Welcome to Sneat! 👋</h4>
//              <p className="mb-4">Please sign-in to your account and start the adventure</p>
//              <form id="formAuthentication" className="mb-3" action="index.html" method="POST" onSubmit={handleSubmit(onSubmit)}>
//                <div className="mb-3">
//                  <label htmlFor="email" className="form-label">Email or Username</label>
//                  <input type="text" className={"form-control " + (errors.username ? 'error' : '')} id="email" name="email-username" placeholder="Enter your email or username" {...register("username",{ required: true,pattern: /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/})} autoFocus={true} />
                
//                </div>
//                {errors.username && <p className='danger'>Please check the Email</p>}
//                <div className="mb-3 form-password-toggle">
//                  <div className="d-flex justify-content-between">
//                    <label className="form-label" htmlFor="password">Password</label>
...
//                  </div>
//                  <div className="input-group input-group-merge">
//                    <input type="password"  id="password" className={"form-control " + (errors.password ? 'error' : '')} name="password" placeholder="············" aria-describedby="password"   {...register("password",{ required: true })}/>
//                    <span className="input-group-text cursor-pointer"><i className="bx bx-hide" /></span>
//                  </div>
//                  {errors.password && <p className='danger'>Please enter the password</p>}
//                </div>
//                <div className="mb-3">
//                  <div className="form-check">
//                    <input className="form-check-input" type="checkbox" id="remember-me" />
